 ...
 * @property {Critter[]} data.critters
 */
function World(t) {
...
function findObjectInArray(t, e, i) {
  for (var o = i.length, s = 0; s < o; s++) if (i[s][t] == e) return i[s];
}
/**
 * 
 * @param {*} t 
...
function CritterContainer(t) {
  ...
  (this.bodyContainer = new createjs.Container()),
    ...
    e.animations.ears4 &&
      ((this.ears.sprite = new createjs.Sprite(i, "ears4")),
      this.ears.addChild(this.ears.sprite),
      (this.hasEars = !0)),
    e.animations.tail4 &&
      ((this.tail.sprite = new createjs.Sprite(i, "tail4")),
  ...
  e.animations.shadow &&
    ((this.baseContainer.sprite = new createjs.Sprite(i, "shadow")),
    this.baseContainer.addChild(this.baseContainer.sprite)),
    this.timeline.addTween(
      createjs.Tween.get(this.bodyContainer)
        .wait(1)
        .to({ y: 4 })
        .wait(1)
        .to({ y: -12 })
    ...
    this.timeline.addTween(
      createjs.Tween.get(this.feetContainer)
        .wait(2)
        .to({ y: -8 })
        .wait(1)
        .to({ y: -16 })
...
function MenuContainer(t) {
  ...
  var e = this,
    i = new boot.Icon("box");
  i.setTransform(760, 420, 0.5, 0.5),
    i.click(function() {
...
function PlayerContainer(t, e) {
  createjs.Container.call(this),
    ...
    (this.targetX = t.x),
    (this.targetY = t.y),
    "mascot" == world.getCritterData(this.critterId).type
      ? (this.critter = new MascotContainer(this.critterId))
      : (this.critter = new CritterContainer(this.critterId)),
    this.extra.scale
      ? ((this.critter.scaleX = this.extra.scale / 2),
        (this.critter.scaleY = this.extra.scale / 2))
      : ((this.critter.scaleX = 0.5), (this.critter.scaleY = 0.5)),
...
(World.prototype = Object.create(GameObject.prototype)),
  ...
  (
    ...
    socket.open(), socket.emit("login", { ticket: t });
  }),
  (
	  /**
	   * 
  ...
  (
    ...
    if ("/" === (t = t.trim()).substr(0, 1)) this.sendCode(t);
      ...
      var e = { i: this.player.playerId, n: this.player.nickname, m: t };
      this.emit("M", e),
        this.stage.room.addMessage(e),
        socket.emit("sendMessage", { message: t });
    }
  }),
  (
	  /**
    ...
    switch (i) {
      ...
      default:
        socket.emit("code", { code: i, options: e });
    }
  }),
  (
	  /**
    ...
    socket && socket.emit("click", { x: t, y: e }),
      this.player &&
        this.stage.room &&
        this.stage.room.movePlayer({ i: this.player.playerId, x: t, y: e });
  }),
  (
	  /**
	   * 
  ...
  (
    ...
    if ("object" == typeof this._events[t])
      for (o = (i = this._events[t].slice()).length, e = 0; e < o; e++)
        i[e].apply(this, s);
  }),
  (World.prototype = Object.create(GameObject.prototype)),
  (
  ...
  (
    ...
    return { i: this.playerId, n: this.nickname, c: this.critterId };
  }),
  (
	  /**
	   * 
  ...
  (
    ...
    for (var e in this.gear) if (this.gear[e] == t) return !0;
    return !1;
  }),
  (
	  /**
  ...
  (
    ...
    this.getPlayer(t) &&
      (delete this.players[t], this.event.emit("removePlayer", t));
  }),
  (
	  /**
	   * 
    ...
    this.on("pressmove", function(t) {
      if (n.edit.visible)
        if (n.editReg);
          ...
          (n.x = a), (n.y = r), (n.data.x = a), (n.data.y = r);
        }
    }),
  ...
  (
    ...
    i.addChild(a, o), (i.y = 0 - s.height - 80), this.addChild(i);
    a = this;
    setTimeout(function() {
      a.removeChild(i);
    }, 5e3);
  ...
  (
    ...
    var i = new boot.Message(
      { text: t },
      { style: "warning", width: 340, height: 100 }
    );
  ...
  (
    ...
    var e = new boot.Message(t, { style: "light" });
  ...
  (
    ...
    1 < t && t < 7
      ? (this.isForward || ((this.isForward = !0), this.updateDepth()),
        this.face.sprite.gotoAndStop("face" + t),
        (this.face.visible = !0))
      : (this.isForward && ((this.isForward = !1), this.updateDepth()),
        (this.face.visible = !1)),
    this.slots)) {
  ...
  (
    ...
    "move" == t
      ? ((this.state = t), this.gotoAndPlay(0))
      : ((this.state = t), this.gotoAndStop(0));
  }),
  ...
  (
    ...
    null != t.frame &&
      (o = new createjs.Sprite(this.room.spritesheet)).gotoAndStop(t.frame);
    t.symbol &&
      (o = new createjs.Sprite(this.room.symbols)).gotoAndPlay(t.symbol);
    t.sprite &&
      (o = new createjs.Sprite(this.room.spritesheet)).gotoAndPlay(t.sprite);
  ...
  (MapContainer.prototype.addTile = function(t, e, i) {
    ...
    o.beginStroke("white")
      .beginFill(this.fills[i])
      .drawRect(0, 0, this.data.tileSize, this.data.tileSize);
    var s = new createjs.Shape(o);
    s.setTransform(t * this.data.tileSize, e * this.data.tileSize),
      (s.alpha = 0.4);
    var a = this;
    s.on("click", function() {
      a.removeChild(this), a.addTile(t, e, a.activeTile);
    }),
  ...
  (MascotContainer.prototype.updateState = function(t) {
    "move" == t
      ? this.sprite.gotoAndPlay("move" + this.currentDirection)
      : this.updateDirection();
  }),
  ...
  (PlayerContainer.prototype.moveTo = function(t, e, i) {
    if (!this.isMoving || this.targetX != t || this.targetY != e) {
      ...
      var s = calculateDistance(this.x, this.y, t, e) * this.speed,
        a = this;
      this.tween = createjs.Tween.get(this, { override: !0 })
        .to({ x: t, y: e }, s, createjs.Ease.linear)
        .call(function() {
          (this.isMoving = !1),
            this.updateState("wait"),
...
function RoomContainer(t) {
  if (
    ...
    world.data &&
      world.data.symbols &&
      (this.symbols = new createjs.SpriteSheet(world.getData("symbols"))),
    world.data &&
      world.data.effects &&
      (this.effects = new createjs.SpriteSheet(world.getData("effects"))),
...
(artwork.edit = new createjs.Bitmap("/media/ui/edit_btn.png").setTransform(
  -10,
  -10,
  0.5,
  0.5
  ...
  (RoomContainer.prototype.addForeground = function(t) {
    var e = new createjs.Bitmap(t);
    (e.hitArea = new createjs.Shape(
      new createjs.Graphics().f("#FF0000").drawRect(0, 0, 0, 0)
    )),
    ...
    if (
      ...
      (o.handleMove = function() {
        ...
        if (this.currentTile != t) {
          ...
          e &&
            (e.z != this.z && (this.updateLayer(e.z), s.swapLayer(this, e.z)),
        ...
        0 < t &&
          i <= s.maxLayer &&
          this.z != i &&
          (this.updateLayer(i), s.swapLayer(this, i));
      }),
        (o.handleStop = function() {
          this.isLocal &&
            (s.focus(this.x, this.y),
            world.sendTrigger({ x: this.x, y: this.y }));
        });
    }
  }),
  ...
  (RoomContainer.prototype.addAnimations = function() {
    ...
    for (var e in t)
      this.layers[0].addSprite(
        { sprite: e, x: this.startx, y: this.starty },
        this.layers[0]
      );
  }),
  ...
  (RoomContainer.prototype.focus = function(t, e) {
    ...
    n > s.width
      ? (this.x = a < i ? (i < n - a ? a - i : s.width - n) : 0)
      : (this.x = 0),
      h > s.height
        ? (this.y = r < o ? (o < h - r ? r - o : s.height - h) : 0)
        : (this.y = 0),
      (this.focusX = t),
      (this.focusY = e);
  }),
  (RoomContainer.prototype.zoom = function(t) {
    (this.scaleX = t), (this.scaleY = t), this.focus();
  }),
  (RoomContainer.prototype.toggleNicknames = function() {
    this.nicknames.visible
      ? (this.nicknames.visible = !1)
      : (this.nicknames.visible = !0);
  }),
  (RoomContainer.prototype.toggleBalloons = function() {
    this.balloons.visible
      ? (this.balloons.visible = !1)
      : (this.balloons.visible = !0);
  }),
  ...
  (SlotContainer.prototype.addItem = function(t, e) {
    ...
    i
      ...
      : console.error("Item not found", t);
  }),
 ...
 */
  ...
  for (var s = [], a = {}, r = e.inventory.length, n = 0; n < r; n++) {
    ...
    (c.data = h),
      e.gear[h.slot] == h.itemId &&
        ((a[h.slot] = c), o.addItem(h.slot, h.itemId), c.setActive(!0)),
      c.click(function() {
        var t = this.data.slot;
        this.isActive
          ? (o.removeItem(t), delete a[t], this.setActive(!1))
          : (o.addItem(t, this.data.itemId),
            a[t] && a[t].setActive(!1),
  ...
  d.setTransform(790, 20),
    d.click(function() {
      for (var t in ((e.gear = {}), a)) e.gear[t] = a[t].data.itemId;
...
function Background() {
  ...
  (e.alpha = 0.6), e.on("click", function() {}), this.addChild(e);
}
/**
 * @class
 * @constructor
...
!(function() {
  ...
  ((t.prototype = Object.create(
    ...
    (t.prototype.handleDrop = function(t) {
      if (this.draggable && this.isDragged) {
        ...
        for (
          var e = this.stage.getObjectsUnderPoint(this.x, this.y),
            i = e.length,
            o = 0;
          o < i;
          o++
  ...
  ((boot = boot || {}).Data = function(t, e) {
    if ("string" == typeof t) var i = { text: t };
    else i = t;
    return (
      t.style
        ? (i.style = new boot.Style(t.style))
        : (i.style = new boot.Style(e)),
      i
    );
  });
boot = boot || {};
!(function() {
  function t(t) {
    createjs.Container.call(this),
      ...
      this.icon.setTransform(2, 2, 0.5, 0.5),
      (this.isActive = !1),
      this.addChild(this.background, this.icon);
  }
  ((t.prototype = Object.create(createjs.Container.prototype)).click = function(
    t
  ) {
    this.on("click", t);
  }),
    (t.prototype.setActive = function(t) {
      t
        ? (this.background.gotoAndStop("item_active"), (this.isActive = !0))
        : (this.background.gotoAndStop("item"), (this.isActive = !1));
    }),
    (boot.Item = t);
})();
boot = boot || {};
!(function() {
  var e = {
      primary: { fill: "#007bff", text: "#ffffff" },
      secondary: { fill: "#6c757d", text: "#ffffff" },
      success: { fill: "#28a745", text: "#ffffff" },
      warning: { fill: "#ffc107", text: "#212529" },
      danger: { fill: "#dc3545", text: "#ffffff" },
      light: { fill: "#f8f9fa", text: "#212529" },
      dark: { fill: "#343a40", text: "#ffffff" }
    },
    i = {
      sm: { font_size: 0.875, mx: 0.5, my: 0.5 },
      md: { font_size: 1, mx: 1, my: 0.625 },
      lg: { font_size: 1.25, mx: 1.25, my: 0.75 }
    };
  boot.Style = function(t) {
    t ? "string" == typeof t && (t = { theme: t }) : (t = {}),
      (this.theme = t.theme || "primary"),
      (this.size = t.size || "md"),
      (this.base = t.base || 16),
      (this.radius = 0.25 * this.base),
...
!(function() {
  function t(t) {
    ...
    var s = new createjs.Shape(o);
    (s.alpha = 0.6), s.on("click", function() {}), this.addChild(s);
  }
  ((t.prototype = Object.create(createjs.Container.prototype)).click = function(
    t
  ) {
...
!(function() {
  function t(t) {
    ...
    (a.textAlign = "center"), a.setTransform(100, 220), this.addChild(a);
  }
...
!(function() {
  function t() {
    ...
    t.setTransform(0, 0, 0.5, 0.5), this.addChild(t);
  }
  ((t.prototype = Object.create(createjs.Container.prototype)).click = function(
    t,
    e
...
!(function() {
  ...
  ((t.prototype = Object.create(
    ...
    (t.prototype.update = function() {
      (this.nextY = 0),
        this.children.forEach(function(t) {
          (t.y = this.nextY), (this.nextY += t.height + 10);
        }, this);
    }),
    (boot.List = t);
})();
...
!(function() {
  function t(t, e) {
    ...
    this.height = 20;
    if ((t.name ? (this.name = t.name) : (this.name = "message"), t.title)) {
    ...
    if (t.image) {
      ...
      o.setTransform(20, height, 0.5, 0.5),
        this.addChild(o),
        (this.height += 330);
    }
    if (t.text) {
      ...
      (s.snapToPixel = !0),
        ...
        (s.lineWidth = 300);
      var a = s.getBounds();
      (this.height += a.height), this.addChild(s);
    }
    this.height += 20;
    ...
    n.setTransform(330, 10), n.click(this.close, this), this.addChild(n);
  }
  ((t.prototype = Object.create(boot.Container.prototype)).center = function(
    t
  ) {
    var e = t.width;
    t.height;
...
!(function() {
  function t(t) {
    ...
    t.forEach(function(t) {
      ...
      var i;
      "message" == t.type &&
        ((i = new boot.Message(t.data, t.style)).setTransform(t.x, t.y),
        o.addChild(i));
      "alert" == t.type &&
        ((i = new boot.Message(t.data, { theme: "warning" })).setTransform(
          t.x,
          t.y
        ),
        o.addChild(i));
