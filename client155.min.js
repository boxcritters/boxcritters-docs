/**
 * @memberdef Stage
 * @see https://www.createjs.com/docs/easeljs/classes/Stage.html
 */
/**
 * @memberdef Shape
 * @see https://www.createjs.com/docs/easeljs/classes/Shape.html
 */
/**
 * @memberdef Bitmap
 * @see https://www.createjs.com/docs/easeljs/classes/Bitmap.html
 */

 /**
 * @memberdef Container
 * @see https://www.createjs.com/docs/easeljs/classes/Container.html
 */

 /**
  * @memberdef HTMLCanvasElement
 ...
 * @constructor
 * @extends {GameObject}
 * @param {HTMLCanvasElement} t canvas element to display the game in 
 */
function World(t) {
 ...
 * @constructor
 * @param {Object} t 
 * @param {Number} t.tileSize
 * @param {Object} t.tileMap
 * @param {Object[]} t.tileTriggers
 */
function Map(t) {
	/**
	 * @member {Number}
 ...
 * @constructor
 * @extends {GameObject}
 * @param {Object} t Player Info
 * @param {Object} t.playerId Player ID
 * @param {Object} t.nickname Player's Nickname
 * @param {Object} t.critterId Critter ID
 * @param {Object} t.inventory Player Inventory
 * @param {Object} t.friends
 * @param {Object} t.gear
 * @param {Object} t.gems
 * @param {Object} t.coins Number of Coins
 */
function Player(t) {
  GameObject.call(this),
 ...
 * @constructor
 * @param {Object} t
 * @param {Object} t.roomId Room ID
 * @param {String} t.name Room Name
 * @param {Object} t.triggers
 * @param {Object} t.map Map Setup
 * @param {Object} t.map.triggers
 * @param {Object[]} t.layers
 * @param {Object[]} t.players Players in the room
 */
function Room(t) {
	/**
	 * Room ID
...
/**
 * Creates chatt bubble
 * @function
 * @param {Number} t Somthing relating to X
 * @param {Number} e Somthing relating to Y
 * @returns {Shape}
 */
 ...
 * @constructor
 * @param {Object} t
 * @param {String} t.itemId Image Name
 * @param {String} t.name Beep Title
 * @param {String} t.title Beep Title
 * @param {String} t.text Beep Text
 */
function BeepItem(t) {
 /**
  * Container for the Beep
  * @member {Container}
  */
...
function StageContainer(t, e) {
  ...
  /**
   * The width of the canvas is pixels
   * @member {Number}
   */
    (this.width = 850),
	/**
	 * The height of the canvas is pixels
	 * @member {Number}
	 */
    (this.height = 480),
    this.room,
